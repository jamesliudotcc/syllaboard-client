...
import { instructorDashboardReducer, InstructorDashboardState } from './instructor_dashboard_reducer';
import { notificationsReducer, NotificationState } from './notifications_reducer';
import { studentDashboardReducer, StudentDashboardState } from './student_dashboard_reducer';
