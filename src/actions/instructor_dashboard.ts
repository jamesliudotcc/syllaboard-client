...
export enum Actions {
  // UI
  TOGGLE_ADD_ASSIGNMENT = 'INSTRUCTOR_TOGGLE_ADD_ASSIGNMENT',
  TOGGLE_SHOW_ASSIGNMENTS = 'INSTRUCTOR_TOGGLE_SHOW_ASSIGNMENTS',
  TOGGLE_EDIT_ASSIGNMENT = 'INSTRUCTOR_TOGGLE_EDIT_ASSIGNMENT',
  TOGGLE_ADD_DELIVERABLE = 'INSTRUCTOR_TOGGLE_ADD_DELIVERABLE',
  TOGGLE_GRADE_DELIVERABLE = 'INSTRUCTOR_TOGGLE_GRADE_DELIVERABLE',
  TOGGLE_SHOW_DELIVERABLES = 'INSTRUCTOR_TOGGLE_SHOW_DELIVERABLES',
  TOGGLE_SHOW_COHORTS = 'INSTRUCTOR_TOGGLE_SHOW_COHORTS',
  // Cohort
  COHORT_REFRESH_STORE = 'INSTRUCTOR_COHORT_REFRESH_STORE',
  // Assignment
  ASSIGNMENT_REFRESH_STORE = 'INSTRUCTOR_ASSIGNMENT_REFRESH_STORE',
  ASSIGNMENT_ADD_TO_STORE = 'INSTRUCTOR_ASSIGNMENT_ADD_TO_STORE',
  ASSIGNMENT_UPDATE_IN_STORE = 'INSTRUCTOR_ASSIGNMENT_UPDATE_IN_STORE',
  ASSIGNMENT_REMOVE_FROM_STORE = 'INSTRUCTOR_ASSIGNMENT_REMOVE_FROM_STORE',
  ASSIGNMENT_SELECT = 'INSTRUCTOR_ASSIGNMENT_SELECT',
  // Deliverable
  DELIVERABLE_REFRESH_STORE = 'INSTRUCTOR_DELIVERABLE_REFRESH_STORE',
  DELIVERABLE_ADD_TO_STORE = 'INSTRUCTOR_DELIVERABLE_ADD_TO_STORE',
  DELIVERABLE_UPDATE_IN_STORE = 'INSTRUCTOR_DELIVERABLE_UPDATE_IN_STORE',
  DELIVERABLE_REMOVE_FROM_STORE = 'INSTRUCTOR_DELIVERABLE_REMOVE_FROM_STORE',
  DELIVERABLE_SELECT = 'INSTRUCTOR_DELIVERABLE_SELECT',
  OTHER_ACTION = 'INSTRUCTOR__any_other_action__',
}
